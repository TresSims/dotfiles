...
theme.focus = "#7aa2f7"
theme.purple = "#bb9af7"
theme.hilight = "#c0caf5"
theme.forground = "#a9b1d6"
theme.gray_1 = "#9aa5ce"
theme.gray_2 = "#565f89"
theme.gray_3 = "#414868"
...
theme.border_normal = theme.gutter
theme.border_focus = theme.focus
theme.border_marked = theme.red
-- }}}

-- {{{ Titlebars
theme.titlebar_bg_focus = theme.focus
...
-- {{{ Mouse finder
theme.mouse_finder_color = theme.yellow
