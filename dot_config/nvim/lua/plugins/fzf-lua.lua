return {
	...
	keys = {
		...
		{ "<leader>/", "<cmd>lua FzfLua.live_grep({ cwd = Util.root.get() })<cr>", desc = "Grep (Root Dir)" },
		{ "<leader>:", "<cmd>FzfLua command_history<cr>", desc = "Command History" },
		{ "<leader><space>", "<cmd>lua FzfLua.files({ cwd=Util.root.get()})<cr>", desc = "Find Files (Root Dir)" },
		-- find
		...
		{ "<leader>sg", "<cmd>lua FzfLua.live_grep({ cwd = Util.root.get() })<cr>", desc = "Grep (Root Dir)" },
		...
		{ "<leader>sw", "<cmd>lua FzfLua.grep_cword({cwd=Util.root.get()})<cr>", desc = "Word (Root Dir)" },
		{ "<leader>sw", "<cmd>lua FzfLua.grep_visual({cwd=Util.root.get()})<cr>", mode = "x", desc = "Selection (Root Dir)", }, 
